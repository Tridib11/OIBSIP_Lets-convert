...
class _HomeScreenState extends State<HomeScreen> {
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  DropdownButton(
                    items: _measures.map((String value) => DropdownMenuItem(value: value,child: Text(value),)).toList(),
                    onChanged: (value) {
                      setState(() {
                        _fromMeasures = value;
                      });
  ...
  void _convert() {
    ...
    if(_value != 0 && _fromMeasures != Null && _toMeasures != Null){
